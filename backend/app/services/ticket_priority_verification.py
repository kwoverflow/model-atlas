...
VERSION = "ticket-priority-verification-v1.1"
PROMPT = (
...
def classifier_response_schema() -> dict:
    schema = PriorityIntent.model_json_schema()
    # Ollama's grammar expansion rejects the large repetition bound. Enforce it locally instead.
    schema["properties"]["evidence"].pop("maxLength")
    return schema
